...
CREATE TABLE public.trips (
	...
	gen_begindate TIMESTAMPTZ GENERATED ALWAYS AS (text2tstz(data #>> '{Route,Calendar,OperationSchedule,Start}')) STORED NULL,
	gen_enddate TIMESTAMPTZ GENERATED ALWAYS AS (text2tstz(data #>> '{Route,Calendar,OperationSchedule,Stop}')) STORED NULL,
	geo public.geometry NULL,
