...
namespace DataModel.helpers
{
    public static class AdditionalPropertiesHelper
    {
        ...
        public static void FillSiagMuseumAdditionalProperties(this ODHActivityPoi odhActivityPoi)
        {
            ...
            if (odhActivityPoi.PoiProperty != null && odhActivityPoi.PoiProperty.Where(x => x.Value.Any(y => y.Name == "openingtimes")).Count() > 0)
                addprop.OpeningTimes = ExtractFromPoiProperty.ExtractValuesFromPoiProperty(odhActivityPoi.PoiProperty, "openingtimes");
        ...
        public static void FillStaVendingPointAdditionalProperties(this ODHActivityPoi odhActivityPoi)
        {
            ...
            if (odhActivityPoi.AdditionalProperties != null && odhActivityPoi.AdditionalProperties.ContainsKey(additionalpropertieskey))
            {
                addprop.HasWebsite = odhActivityPoi.AdditionalProperties[additionalpropertieskey].HasWebsite;
                addprop.Duplicate = odhActivityPoi.AdditionalProperties[additionalpropertieskey].Duplicate;
                addprop.MobileCard = odhActivityPoi.AdditionalProperties[additionalpropertieskey].MobileCard;                
            }
            else
            {
